...
export const translations: Record<Locale, Translations> = {
  ...
  fr: { // Placeholder French translations
    addActivity: "[FR] Add Activity",
    manageCategories: "[FR] Categories",
    ...
    lightTheme: "[FR] Light",
    darkTheme: "[FR] Dark",
    systemTheme: "[FR] System",
    moreOptions: "[FR] More options",
    moreOptionsDesktop: "[FR] Settings",
    personalMode: "[FR] Personal",
    workMode: "[FR] Work",
    switchToPersonalMode: "[FR] Switch to Personal Mode",
    switchToWorkMode: "[FR] Switch to Work Mode",
    logout: "[FR] Logout",
    changePassword: "[FR] Change Password",
    dashboard: "[FR] Dashboard",
    notificationsTitle: "[FR] Notifications",
    noNotificationsYet: "[FR] No new notifications.",
    notificationUnread: "[FR] unread",
    markAllAsRead: "[FR] Mark all as read",
    clearAllNotifications: "[FR] Clear all",
    notificationBellLabel: "[FR] View notifications",
    viewHistory: "[FR] View History",
    enableSystemNotifications: "[FR] Enable System Notifications",
    systemNotificationsEnabled: "[FR] System Notifications Enabled",
    systemNotificationsBlocked: "[FR] System Notifications Blocked",
    backToCalendar: "[FR] Back to Calendar",
    addCategory: "[FR] Add Category",
    editCategory: "[FR] Edit Category",
    addNewCategory: "[FR] Add New Category",
    updateCategoryDetails: "[FR] Update the details of your category.",
    createCategoryDescription: "[FR] Create a new category for your activities.",
    categoryName: "[FR] Category Name",
    iconName: "[FR] Icon Name (from Lucide)",
    iconNameDescriptionLink: "[FR] Enter a PascalCase icon name from <a>lucide.dev/icons</a>.",
    categoryMode: "[FR] Category Mode",
    modePersonal: "[FR] Personal",
    modeWork: "[FR] Work",
    modeAll: "[FR] All Modes",
    saveChanges: "[FR] Save Changes",
    cancel: "[FR] Cancel",
    existingCategories: "[FR] Existing Categories",
    viewEditManageCategories: "[FR] View, edit, and manage your current categories.",
    delete: "[FR] Delete",
    confirmDelete: "[FR] Are you sure?",
    confirmDeleteCategoryDescription: (params) => `[FR] This action will delete the category "${params.categoryName}". Activities using this category will no longer be associated with it. This cannot be undone.`,
    categoriesCount: (params) => `[FR] You have ${params.count} categor${params.count === 1 ? 'y' : 'ies'}.`,
    noCategoriesYet: "[FR] No categories added yet. Use the form to add your first category.",
    editActivityTitle: "[FR] Edit Activity",
    addActivityTitle: "[FR] Add New Activity",
    editActivityDescription: (params) => `[FR] Update the details of your activity. Default date: ${params.formattedInitialDate}.`,
    addActivityDescription: (params) => `[FR] Fill in the details for your new activity. Default date: ${params.formattedInitialDate}.`,
    activityTitleLabel: "[FR] Activity Title",
    categoryLabel: "[FR] Category",
    selectCategoryPlaceholder: "[FR] Select a category",
    loadingCategoriesPlaceholder: "[FR] Loading categories...",
    activityDateLabel: "[FR] Start Date / Date",
    pickADate: "[FR] Pick a date",
    activityTimeLabel: "[FR] Activity Time (HH:MM)",
    activityNotesLabel: "[FR] Notes",
    activityNotesPlaceholder: "[FR] Add any additional details or links here...",
    todosLabel: "[FR] Todos",
    addTodo: "[FR] Add Todo",
    newTodoPlaceholder: "[FR] New todo item",
    toastActivityUpdatedTitle: "[FR] Activity Updated",
    toastActivityUpdatedDescription: "[FR] Your activity has been successfully updated.",
    toastActivityAddedTitle: "[FR] Activity Added",
    toastActivityAddedDescription: "[FR] Your new activity has been successfully added.",
    recurrenceLabel: "[FR] Recurrence",
    recurrenceTypeLabel: "[FR] Repeats",
    recurrenceNone: "[FR] None",
    recurrenceDaily: "[FR] Daily",
    recurrenceWeekly: "[FR] Weekly",
    recurrenceMonthly: "[FR] Monthly",
    recurrenceEndDateLabel: "[FR] End Date",
    recurrenceNoEndDate: "[FR] No end date",
    recurrencePickEndDate: "[FR] Pick end date",
    recurrenceDaysOfWeekLabel: "[FR] On Days",
    recurrenceDayOfMonthLabel: "[FR] Day of Month",
    recurrenceDayOfMonthPlaceholder: "[FR] e.g., 15",
    recurrenceClearEndDate: "[FR] Clear end date",
    daySun: "[FR] Sun",
    dayMon: "[FR] Mon",
    dayTue: "[FR] Tue",
    dayWed: "[FR] Wed",
    ...
    dayFri: "[FR] Fri",
    daySat: "[FR] Sat",
    invalidTimeFormat24Hour: "[FR] Invalid time format. Use HH:MM (24-hour).",
    timeFormatDescription24Hour: "[FR] Please use 24-hour format (e.g., 14:30).",
    activitiesForDate: (params) => `[FR] Activities for ${params.date}`,
    activitiesForWeek: (params) => `[FR] Activities for week: ${params.startDate} - ${params.endDate}`,
    activitiesForMonth: (params) => `[FR] Activities for ${params.month}`,
    loadingDate: "[FR] Loading date...",
    noActivitiesForDay: "[FR] No activities scheduled for this day.",
    noActivitiesForPeriod: "[FR] No activities scheduled for this period.",
    selectDateToSeeActivities: "[FR] Select a date to see activities.",
    confirmDeleteActivityTitle: "[FR] Are you sure?",
    confirmDeleteActivityDescription: (params) => `[FR] This action cannot be undone. This will permanently delete the activity "${params.activityTitle}" and all its associated todos. If it's a recurring activity, the entire series will be deleted.`,
    toastActivityDeletedTitle: "[FR] Activity Deleted",
    toastActivityDeletedDescription: (params) => `[FR] "${params.activityTitle}" has been removed.`,
    todayButton: "[FR] Today",
    viewDaily: "[FR] Daily",
    viewWeekly: "[FR] Weekly",
    viewMonthly: "[FR] Monthly",
    allActivitiesCompleted: "[FR] Well done! All activities for this period are complete.",
    editActivitySr: "[FR] Edit Activity",
    deleteActivitySr: "[FR] Delete Activity",
    todosCompleted: (params) => `[FR] ${params.completed} / ${params.total} todos completed`,
    noDetailsAvailable: "[FR] No details available.",
    noTodosForThisActivity: "[FR] No todos for this activity.",
    recurrenceDailyText: "[FR] Daily",
    recurrenceWeeklyText: "[FR] Weekly",
    recurrenceMonthlyText: "[FR] Monthly",
    loginWelcomeMessage: "[FR] Log in to manage your activities.",
    loginUsernameLabel: "[FR] Username",
    loginPasswordLabel: "[FR] Password",
    loginUsernamePlaceholder: "[FR] Enter your username",
    loginPasswordPlaceholder: "[FR] Enter your password",
    loginButtonText: "[FR] Login",
    loginLoggingIn: "[FR] Logging in...",
    loginInvalidCredentials: "[FR] Invalid username or password.",
    loginErrorTitle: "[FR] Login Error",
    loginLockoutTitle: "[FR] Temporarily Locked Out",
    loginLockoutMessage: (params) => `[FR] Too many failed login attempts. Please try again in ${params.seconds} seconds.`,
    loginUsernameRequired: "[FR] Username is required.",
    loginPasswordRequired: "[FR] Password is required.",
    loginSecurityNotice: "[FR] This is a prototype. Do not use real credentials.",
    loginRedirecting: "[FR] Redirecting...",
    rememberMeLabel: "[FR] Keep me logged in for 30 days",
    showPassword: "[FR] Show password",
    hidePassword: "[FR] Hide password",
    changePasswordModalTitle: "[FR] Change Password",
    changePasswordModalDescription: "[FR] Enter your current password and a new password below.",
    currentPasswordLabel: "[FR] Current Password",
    newPasswordLabel: "[FR] New Password",
    confirmNewPasswordLabel: "[FR] Confirm New Password",
    currentPasswordPlaceholder: "[FR] Your current password",
    newPasswordPlaceholder: "[FR] Your new password",
    confirmNewPasswordPlaceholder: "[FR] Confirm your new password",
    updatePasswordButton: "[FR] Update Password",
    passwordUpdateSuccessTitle: "[FR] Password Updated",
    passwordUpdateSuccessDescription: "[FR] Your password has been successfully updated. (Prototype: Not actually changed)",
    passwordUpdateErrorIncorrectCurrent: "[FR] Incorrect current password.",
    passwordUpdateErrorNewPasswordRequired: "[FR] New password is required.",
    passwordUpdateErrorConfirmPasswordRequired: "[FR] Confirm new password is required.",
    passwordUpdateErrorPasswordsDoNotMatch: "[FR] New passwords do not match.",
    passwordUpdateErrorCurrentEqualsNew: "[FR] New password must be different from the current password.",
    passwordMinLength: (params) => `[FR] Password must be at least ${params.length} characters.`,
    toastCategoryAddedTitle: "[FR] Category Added",
    toastCategoryAddedDescription: (params) => `[FR] Category "${params.categoryName}" has been added.`,
    toastCategoryUpdatedTitle: "[FR] Category Updated",
    toastCategoryUpdatedDescription: (params) => `[FR] Category "${params.categoryName}" has been updated.`,
    toastCategoryDeletedTitle: "[FR] Category Deleted",
    toastCategoryDeletedDescription: (params) => `[FR] Category "${params.categoryName}" has been removed.`,
    toastActivityStartingSoonTitle: "[FR] Activity Starting Soon!",
    toastActivityStartingSoonDescription: (params) => `[FR] "${params.activityTitle}" is scheduled for ${params.activityTime}.`,
    toastActivityTomorrowTitle: "[FR] Activity Reminder: Tomorrow",
    toastActivityTomorrowDescription: (params) => `[FR] "${params.activityTitle}" is scheduled for tomorrow.`,
    toastActivityInTwoDaysTitle: "[FR] Activity Reminder: In 2 Days",
    toastActivityInTwoDaysDescription: (params) => `[FR] "${params.activityTitle}" is scheduled in 2 days.`,
    toastActivityInOneWeekTitle: "[FR] Activity Reminder: In 1 Week",
    toastActivityInOneWeekDescription: (params) => `[FR] "${params.activityTitle}" is scheduled in one week.`,
    dashboardTitle: "[FR] Activity Dashboard",
    dashboardMainDescription: "[FR] Track your activity progress and view summaries.",
    dashboardChartView: "[FR] Chart View",
    dashboardListView: "[FR] List View",
    dashboardViewWeekly: "[FR] Last 7 Days",
    dashboardViewMonthly: "[FR] Current Month (by Week)",
    dashboardChartTotalActivities: "[FR] Total Activities",
    dashboardChartCompletedActivities: "[FR] Completed Activities",
    dashboardWeekLabel: "[FR] W", // Semaine
    dashboardNoData: "[FR] No activity data available for the selected period.",
    dashboardListLast7Days: "[FR] Last 7 Days",
    dashboardListCurrentMonth: "[FR] Current Month",
    dashboardNoActivitiesForList: "[FR] No activities found for the selected period.",
    dashboardNotesLabel: "[FR] Notes",
    historyPageTitle: "[FR] Activity History",
    historyPageDescription: "[FR] Recent actions performed during this session.",
    noHistoryYet: "[FR] No activity recorded in this session yet.",
    historyLogLogin: "[FR] Logged in.",
    historyLogLogout: "[FR] Logged out.",
    historyLogAddActivityPersonal: (params) => `[FR] Added Personal Activity: "${params.title}".`,
    historyLogAddActivityWork: (params) => `[FR] Added Work Activity: "${params.title}".`,
    historyLogUpdateActivityPersonal: (params) => `[FR] Updated Personal Activity: "${params.title}".`,
    historyLogUpdateActivityWork: (params) => `[FR] Updated Work Activity: "${params.title}".`,
    historyLogDeleteActivityPersonal: (params) => `[FR] Deleted Personal Activity: "${params.title}".`,
    historyLogDeleteActivityWork: (params) => `[FR] Deleted Work Activity: "${params.title}".`,
    historyLogToggleActivityCompletionPersonal: (params) => `[FR] Marked Personal Activity "${params.title}" as ${params.completed ? 'completed' : 'incomplete'}.`,
    historyLogToggleActivityCompletionWork: (params) => `[FR] Marked Work Activity "${params.title}" as ${params.completed ? 'completed' : 'incomplete'}.`,
    historyLogAddCategoryPersonal: (params) => `[FR] Added Personal Category: "${params.name}".`,
    historyLogAddCategoryWork: (params) => `[FR] Added Work Category: "${params.name}".`,
    historyLogAddCategoryAll: (params) => `[FR] Added Category (All Modes): "${params.name}".`,
    historyLogUpdateCategoryPersonal: (params) => `[FR] Updated Personal Category: "${params.name}".`,
    historyLogUpdateCategoryWork: (params) => `[FR] Updated Work Category: "${params.name}".`,
    historyLogUpdateCategoryAll: (params) => `[FR] Updated Category (All Modes): "${params.name}".`,
    historyLogDeleteCategory: (params) => `[FR] Deleted Category: "${params.name}".`,
    historyLogSwitchToPersonalMode: "[FR] Switched to Personal Mode.",
    historyLogSwitchToWorkMode: "[FR] Switched to Work Mode.",
    historyLogPasswordChange: "[FR] Password changed.",
    historyScopeAccount: "[FR] Account",
    historyScopePersonal: "[FR] Personal",
    historyScopeWork: "[FR] Work",
    historyScopeCategory: "[FR] Category",
    motivationalPhrases: [
      "[FR] The secret of getting ahead is getting started.",
      "[FR] Don't watch the clock; do what it does. Keep going.",
      "[FR] The only way to do great work is to love what you do.",
