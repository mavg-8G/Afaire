    ...
    <DayPicker
      ...
      classNames={{
        ...
        cell: cn(
          ...
          "[&:has([aria-selected])]:bg-primary", // Changed from bg-accent to bg-primary
        ...
        day_outside:
          "day-outside text-muted-foreground opacity-50 aria-selected:bg-accent/50 aria-selected:text-muted-foreground aria-selected:opacity-100", // Ensure opacity is full for selected outside days
